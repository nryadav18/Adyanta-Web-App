                        ...
                        <div className="menu-area">
                            <div className="menu">
                                <ul className={`lab-ul ${menuToggle ? "active" : ""}`}>
                                    ...
                                    <li className="menu-item-has-children">
                                        <a href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,0">University</a>
                                        <ul className="lab-ul dropdown-menu">
                                            <li><NavLink to="/avicenna">Avicenna International Medical University</NavLink></li>
                                            <li><NavLink to="/european">International European University</NavLink></li>
                                            <li><NavLink to="/georgia">Georgia Universities</NavLink></li>
                                            <li><NavLink to="/uzbekistan">Uzbekistan Universities</NavLink></li>
                                            <li><NavLink to="/russia">Russia Universities</NavLink></li>
                                            <li><NavLink to="/america">Central America Universities</NavLink></li>
                                            <li><NavLink to="/kazakhstan">Kazakhstan Universities</NavLink></li>
                                        </ul>
                                    </li>
