...
const title = "Dream Big Study in Spain...!";
const desc = "Turn your Spain study aspirations into reality - it's closer than ever!";
...
const categoryList = [
    {
        link: 'https://adyanta.co/masters-spain',
        text: 'Study at Spain Universities',
        className: 'course-cate adyanta-bg-color',
    }
]


const MastersEightPageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/masters/std_spain.png" alt="nryadav" className="w-100" />
...
export default MastersEightPageHeader;