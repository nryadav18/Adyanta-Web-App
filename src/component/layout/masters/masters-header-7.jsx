...
const desc = "Turn your Italy study aspirations into reality - it's closer than ever!";
...
const categoryList = [
    {
        link: 'https://adyanta.co/masters-italy',
        text: 'Study at Italy Universities',
        className: 'course-cate adyanta-bg-color',
    }
]


const MastersSevenPageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/masters/std_italy.jpg" alt="nryadav" className="w-100" />
...
export default MastersSevenPageHeader;