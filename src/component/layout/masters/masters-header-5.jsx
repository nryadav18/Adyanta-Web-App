...
const title = "Dream Big Study in Germany...!";
const desc = "Turn your Germany study aspirations into reality - it's closer than ever!";
...
const categoryList = [
    {
        link: 'https://adyanta.co/masters-germany',
        text: 'Study at German Universities',
        className: 'course-cate adyanta-bg-color',
    }
]


const MastersFivePageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/masters/std_germany.png" alt="nryadav" className="w-100" />
...
export default MastersFivePageHeader;