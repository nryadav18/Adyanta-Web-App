...
const title = "Dream Big Study in UK...!";
const desc = "Turn your UK study aspirations into reality - it's closer than ever!";
...
const categoryList = [
    {
        link: 'https://adyanta.co/masters-uk',
        text: 'Study at UK Universities',
        className: 'course-cate adyanta-bg-color',
    }
]


const MastersFourPageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/masters/std_uk.jpg" alt="nryadav" className="w-100" />
...
export default MastersFourPageHeader;