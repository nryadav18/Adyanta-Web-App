...
const title = "Dream Big Study in Canada...!";
const desc = "Turn your Canada study aspirations into reality - it's closer than ever!";
...
const categoryList = [
    {
        link: 'https://adyanta.co/masters-canada',
        text: 'Study at Canada Universities',
        className: 'course-cate adyanta-bg-color',
    }
]


const MastersTwoPageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/masters/std_canada.png" alt="nryadav" className="w-100" />
...
export default MastersTwoPageHeader;