...
const title = "International European University";
const desc = "Coaching | Admissions | Scholarships | Visas | Immigration | Online | Offline | Blended";
...
const categoryList = [
    {
        ...
        text: 'Visit International European University',
        className: 'course-cate adyanta-bg-color',
    }
]


const UniversityTwoPageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/medical/ieu.png" alt="nryadav" className="w-100" />
...
export default UniversityTwoPageHeader;