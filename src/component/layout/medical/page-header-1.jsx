...
const title = "Avicenna International Medical University";
...
const categoryList = [
    {
        link: 'https://avicenna.edu.kg/en/home-page',
        text: 'Visit Avicenna University',
        className: 'course-cate adyanta-bg-color',
    }
]


const UniversityOnePageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/medical/avicenna1.jpg" alt="nryadav" className="w-100" />
...
export default UniversityOnePageHeader;