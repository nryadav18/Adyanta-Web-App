...
const title = "Georgian Universities";
...
const categoryList = [
    {
        ...
        text: 'Visit Georgian Universities',
        className: 'course-cate adyanta-bg-color',
    }
]


const UniversityThreePageHeader = () => {
    return (
                ...
                <div className="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse">
                    <div className="col-lg-7 col-12">
                        <div className="pageheader-thumb">
                            <img src="assets/fly-assets/medical/georgia.jpg" alt="nryadav" className="w-100" />
...
export default UniversityThreePageHeader;