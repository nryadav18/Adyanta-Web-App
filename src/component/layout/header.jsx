                        ...
                        <div className="menu-area">
                            <div className="menu">
                                <ul className={`lab-ul ${menuToggle ? "active" : ""}`}>
                                    ...
                                    {/* <li className="menu-item-has-children">
                                        <a href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,0">Medical</a>
                                        <ul className="lab-ul dropdown-menu">
                                            <li><NavLink to="/coming-soon">Avicenna International Medical University</NavLink></li>
                                            <li><NavLink to="/coming-soon">International European University</NavLink></li>
                                            <li><NavLink to="/coming-soon">Georgia Universities</NavLink></li>
                                            <li><NavLink to="/coming-soon">Uzbekistan Universities</NavLink></li>
                                            <li><NavLink to="/coming-soon">Russia Universities</NavLink></li>
                                            <li><NavLink to="/coming-soon">Central America Universities</NavLink></li>
                                            <li><NavLink to="/coming-soon">Kazakhstan Universities</NavLink></li>
                                        </ul>
                                    </li> */}
                                    {/* <li className="menu-item-has-children">
                                        <a href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,0">Country</a>
                                        <ul className="lab-ul dropdown-menu">
                                            <li><NavLink to="/coming-soon">North America</NavLink></li>
                                            <li><NavLink to="/coming-soon">Europe</NavLink></li>
                                            <li><NavLink to="/coming-soon">Oceania</NavLink></li>
                                            <li><NavLink to="/coming-soon">Asia & Middle East</NavLink></li>
                                        </ul>
                                        <ul className="lab-ul dropdown-menu">
                                            <li><NavLink to="/blog">Blog Grid</NavLink></li>
                                            <li><NavLink to="/blog-2">Blog Style 2</NavLink></li>
