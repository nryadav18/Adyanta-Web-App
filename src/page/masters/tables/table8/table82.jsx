...
const ShopCartList = [
    {
        ...
        totalPrice: 'To study at an accredited Italy college or university or to study English at an English language institute',
    ...
    },
    {
        ...
        totalPrice: 'For non-academic or vocational study or training in the Italy',
        delImgUrl: 'assets/images/shop/del.png',
        delImgAlt: 'Remove Thumb',
    }
]
            ...
            <div className="shop-cart" style={{ paddingTop: '30px' }}>
                <div className="container">
                    <div className="section-wrapper">
                        <h3>Student visa requirements for the Italy</h3>
                        <h4>The Italy Government offers three different student visa types</h4>
